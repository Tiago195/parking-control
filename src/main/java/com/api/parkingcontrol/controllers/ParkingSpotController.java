...
public class ParkingSpotController {
  ...
  public ResponseEntity<Object> getParkingSpot(@PathVariable(value = "id") UUID id) {
    var pOptional = parkingSpotService.findById(id);
  ...
  public ResponseEntity<Object> deleteParkingSpot(@PathVariable(value = "id") UUID id) {
    ...
    parkingSpotService.delete(pOptional.get());
  ...
  public ResponseEntity<Object> updateParkingSpot(@PathVariable(value = "id") UUID id,
    ...
    var parkingSpotModel = new ParkingSpotModel();
    BeanUtils.copyProperties(parkingSpotDto, parkingSpotModel);
    parkingSpotModel.setId(pOptional.get().getId());
    parkingSpotModel.setRegistrationDate(pOptional.get().getRegistrationDate());
